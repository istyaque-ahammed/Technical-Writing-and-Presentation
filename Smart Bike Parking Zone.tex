...
\bibitem{b8} M. A. Martinez, J. R. Li, and T. K. Vuong, “Development of a smart bike parking system using Arduino Uno,” in Proceedings IEEE International Conference on Robotics and Automation (ICRA), 2020, pp. 4826-4831.
	
\bibitem{b9}  Kuzlu, M.,Karaca, M. " A real-time smart parking system based on the Internet of Things"  in Proceedings of the IEEE International Conference on 24th Signal Processing and Communication Application Conference (SIU),2020 pp.432-435. doi: 10.1109/SIU.2016.7495754
...
\bibitem{b10}Tao, X., Yan, B., Zhang, C., Liu, Y., Zhou, X. " An Internet of Things-Based Intelligent Parking System," in Proceedings IEEE Transactions on Intelligent Transportation Systems,2018, pp. 89-102. doi: 10.1109/TITS.2017.2713362
\end{thebibliography}
